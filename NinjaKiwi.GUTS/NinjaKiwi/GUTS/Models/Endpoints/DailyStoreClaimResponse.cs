...
public class DailyStoreClaimResponse : EndpointResponseBase, IEndpointResponse
{
	[CompilerGenerated]
	private DailyStoreInfo <DailyStoreInfo>k__BackingField; //Field offset: 0x18
	[CompilerGenerated]
	private Dictionary<String, Dictionary`2<String, Int64>> <Rewards>k__BackingField; //Field offset: 0x20
	[CompilerGenerated]
	private Dictionary<String, Dictionary`2<String, Int64>> <ShardedRewards>k__BackingField; //Field offset: 0x28
	[CompilerGenerated]
	private Dictionary<String, Dictionary`2<String, Int64>> <NewBalances>k__BackingField; //Field offset: 0x30
	...
	public DailyStoreClaimResponse() { }
