...
[CompilerGenerated]
internal sealed class <>f__AnonymousType144
{
	[DebuggerBrowsable(DebuggerBrowsableState::Never (0))]
	private readonly <provider>j__TPar <provider>i__Field; //Field offset: 0x0
	[DebuggerBrowsable(DebuggerBrowsableState::Never (0))]
	...
	public <provider>j__TPar provider
	{
		 get { } //Length: 5
	}
	...
	[DebuggerHidden]
	public <>f__AnonymousType144`4(<provider>j__TPar provider, <identifier>j__TPar identifier, <confirmation>j__TPar confirmation, <sessionTicket>j__TPar sessionTicket) { }
