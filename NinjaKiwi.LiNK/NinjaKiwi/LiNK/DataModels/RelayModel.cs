...
public class RelayModel
{
	...
	public string uuid; //Field offset: 0x20
	[DataMember(Name = "region")]
	public string region; //Field offset: 0x28
	[DataMember(Name = "expiresAt")]
	public long expiresAt; //Field offset: 0x30
	[DataMember(Name = "load")]
	public int load; //Field offset: 0x38
	[DataMember(Name = "draining")]
	public bool draining; //Field offset: 0x3C
	[DataMember(Name = "dnsResolved")]
	public bool dnsResolved; //Field offset: 0x3D
	[DataMember(Name = "isBackup")]
	public bool isBackup; //Field offset: 0x3E
	[DataMember(Name = "redisSetKey")]
	public string redisSetKey; //Field offset: 0x40
	[DataMember(Name = "redisRelayKey")]
	public string redisRelayKey; //Field offset: 0x48
	[DataMember(Name = "loaded")]
	public bool loaded; //Field offset: 0x50
	[CompilerGenerated]
	private JObject <Metadata>k__BackingField; //Field offset: 0x58
	[CompilerGenerated]
	private Version <BinaryVersion>k__BackingField; //Field offset: 0x60
	[CompilerGenerated]
	private int <PlayerCount>k__BackingField; //Field offset: 0x68
	[CompilerGenerated]
	private string <HostName>k__BackingField; //Field offset: 0x70
