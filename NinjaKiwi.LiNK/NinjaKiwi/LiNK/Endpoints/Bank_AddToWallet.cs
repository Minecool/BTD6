...
public class Bank_AddToWallet : Endpoint<TypeA>
{
	[CompilerGenerated]
	private struct <Call>d__1 : IAsyncStateMachine
	{
		...
		public Bank_AddToWallet <>4__this; //Field offset: 0x38
	...
	private struct <Call>d__2 : IAsyncStateMachine
	{
		...
		public Bank_AddToWallet <>4__this; //Field offset: 0x20
	...
	internal Bank_AddToWallet(HttpRequestFactory requestFactory, Authority authority, ApiOptions options) { }
