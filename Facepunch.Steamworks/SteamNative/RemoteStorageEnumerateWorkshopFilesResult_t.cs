...
internal struct RemoteStorageEnumerateWorkshopFilesResult_t
{
	public struct PackSmall
	{
		...
		internal Single[] GScore; //Field offset: 0x18
		internal uint AppId; //Field offset: 0x20
		internal uint StartIndex; //Field offset: 0x24

		public static RemoteStorageEnumerateWorkshopFilesResult_t op_Implicit(PackSmall d) { }
