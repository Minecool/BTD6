...
internal struct GetAppDependenciesResult_t
{
	public struct PackSmall
	{
		...
		internal AppId_t[] GAppIDs; //Field offset: 0x10
		internal uint NumAppDependencies; //Field offset: 0x18
		internal uint TotalNumAppDependencies; //Field offset: 0x1C

		public static GetAppDependenciesResult_t op_Implicit(PackSmall d) { }
