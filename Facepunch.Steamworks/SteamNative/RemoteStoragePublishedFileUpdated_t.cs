...
internal struct RemoteStoragePublishedFileUpdated_t
{
	public struct PackSmall
	{
		...
		internal ulong Unused; //Field offset: 0xC

		public static RemoteStoragePublishedFileUpdated_t op_Implicit(PackSmall d) { }

	}

	internal ulong PublishedFileId; //Field offset: 0x0
	internal uint AppID; //Field offset: 0x8
	internal ulong Unused; //Field offset: 0x10
