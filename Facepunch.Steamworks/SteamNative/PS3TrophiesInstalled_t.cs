...
internal struct PS3TrophiesInstalled_t
{
	public struct PackSmall
	{
		...
		internal ulong RequiredDiskSpace; //Field offset: 0xC

		public static PS3TrophiesInstalled_t op_Implicit(PackSmall d) { }

	}

	internal ulong GameID; //Field offset: 0x0
	internal Result Result; //Field offset: 0x8
	internal ulong RequiredDiskSpace; //Field offset: 0x10
