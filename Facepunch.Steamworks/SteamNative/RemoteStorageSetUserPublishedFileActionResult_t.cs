...
internal struct RemoteStorageSetUserPublishedFileActionResult_t
{
	public struct PackSmall
	{
		...
		internal WorkshopFileAction Action; //Field offset: 0xC

		public static RemoteStorageSetUserPublishedFileActionResult_t op_Implicit(PackSmall d) { }

	}

	internal Result Result; //Field offset: 0x0
	internal ulong PublishedFileId; //Field offset: 0x8
	internal WorkshopFileAction Action; //Field offset: 0x10
