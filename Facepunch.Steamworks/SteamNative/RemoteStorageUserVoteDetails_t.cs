...
internal struct RemoteStorageUserVoteDetails_t
{
	public struct PackSmall
	{
		...
		internal WorkshopVote Vote; //Field offset: 0xC

		public static RemoteStorageUserVoteDetails_t op_Implicit(PackSmall d) { }

	}

	internal Result Result; //Field offset: 0x0
	internal ulong PublishedFileId; //Field offset: 0x8
	internal WorkshopVote Vote; //Field offset: 0x10
