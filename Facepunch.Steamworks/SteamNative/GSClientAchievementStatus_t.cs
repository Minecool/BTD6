...
internal struct GSClientAchievementStatus_t
{
	public struct PackSmall
	{
		...
		internal string PchAchievement; //Field offset: 0x8
		internal bool Unlocked; //Field offset: 0x10

		public static GSClientAchievementStatus_t op_Implicit(PackSmall d) { }
