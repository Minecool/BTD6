...
internal struct RemoteStorageUpdatePublishedFileResult_t
{
	public struct PackSmall
	{
		...
		internal bool UserNeedsToAcceptWorkshopLegalAgreement; //Field offset: 0xC

		public static RemoteStorageUpdatePublishedFileResult_t op_Implicit(PackSmall d) { }

	}

	internal Result Result; //Field offset: 0x0
	internal ulong PublishedFileId; //Field offset: 0x8
	internal bool UserNeedsToAcceptWorkshopLegalAgreement; //Field offset: 0x10
