...
internal struct RemoveUGCDependencyResult_t
{
	public struct PackSmall
	{
		...
		internal ulong ChildPublishedFileId; //Field offset: 0xC

		public static RemoveUGCDependencyResult_t op_Implicit(PackSmall d) { }

	}

	internal Result Result; //Field offset: 0x0
	internal ulong PublishedFileId; //Field offset: 0x8
	internal ulong ChildPublishedFileId; //Field offset: 0x10
