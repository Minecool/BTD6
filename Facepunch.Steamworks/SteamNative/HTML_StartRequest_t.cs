...
internal struct HTML_StartRequest_t
{
	public struct PackSmall
	{
		...
		internal string PchTarget; //Field offset: 0x10
		internal string PchPostData; //Field offset: 0x18
		internal bool BIsRedirect; //Field offset: 0x20

		public static HTML_StartRequest_t op_Implicit(PackSmall d) { }
