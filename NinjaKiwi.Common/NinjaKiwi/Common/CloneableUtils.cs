...
[Extension]
public static class CloneableUtils
{
	[CompilerGenerated]
	private sealed class <CloneList>d__0 : IEnumerable<T>, IEnumerable, IEnumerator<T>, IEnumerator, IDisposable
	{
		...
		public IList<T> <>3__items; //Field offset: 0x0
		...
		[DebuggerHidden]
		public <CloneList>d__0`1(int <>1__state) { }
	...
	[Extension]
	[IteratorStateMachine(typeof(<CloneList>d__0`1))]
	public static IEnumerable<T> CloneList(IList<T> items) { }
