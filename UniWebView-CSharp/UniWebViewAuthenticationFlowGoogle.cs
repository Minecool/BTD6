...
public class UniWebViewAuthenticationFlowGoogle : UniWebViewAuthenticationCommonFlow, IUniWebViewAuthenticationFlow<UniWebViewAuthenticationGoogleToken>
{
	...
	public UniWebViewAuthenticationFlowGoogleOptional optional; //Field offset: 0x50
	private readonly UniWebViewAuthenticationConfiguration config; //Field offset: 0x58
	[CompilerGenerated]
	[SerializeField]
	private UnityEvent<UniWebViewAuthenticationGoogleToken> <OnAuthenticationFinished>k__BackingField; //Field offset: 0x60
	[CompilerGenerated]
	[SerializeField]
	private UnityEvent<Int64, String> <OnAuthenticationErrored>k__BackingField; //Field offset: 0x68
	[CompilerGenerated]
	[SerializeField]
	private UnityEvent<UniWebViewAuthenticationGoogleToken> <OnRefreshTokenFinished>k__BackingField; //Field offset: 0x70
	[CompilerGenerated]
	[SerializeField]
	...
	public override UnityEvent<UniWebViewAuthenticationGoogleToken> OnAuthenticationFinished
	{
		[CompilerGenerated]
		 get { } //Length: 5
		[CompilerGenerated]
	...
	public override UnityEvent<UniWebViewAuthenticationGoogleToken> OnRefreshTokenFinished
	{
		[CompilerGenerated]
		 get { } //Length: 5
		[CompilerGenerated]
	...
	public UniWebViewAuthenticationFlowGoogle() { }

	public override UniWebViewAuthenticationGoogleToken GenerateTokenFromExchangeResponse(string exchangeResponse) { }

	[CompilerGenerated]
	public override UnityEvent<Int64, String> get_OnAuthenticationErrored() { }

	[CompilerGenerated]
	public override UnityEvent<UniWebViewAuthenticationGoogleToken> get_OnAuthenticationFinished() { }

	[CompilerGenerated]
	public override UnityEvent<Int64, String> get_OnRefreshTokenErrored() { }

	[CompilerGenerated]
	public override UnityEvent<UniWebViewAuthenticationGoogleToken> get_OnRefreshTokenFinished() { }
