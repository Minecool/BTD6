...
public class HotkeysScreen : GameMenu
{
	...
	private sealed class <>c
	{
		...
		public static Func<KeyValuePair`2<String, HotKey>, Int32> <>9__24_0; //Field offset: 0x8
		public static Func<KeyValuePair`2<String, HotKey>, Boolean> <>9__24_1; //Field offset: 0x10

		private static <>c() { }

		public <>c() { }

		internal int <PopulateFields>b__24_0(KeyValuePair<String, HotKey> hotkeyDictionaryPair) { }

		internal bool <PopulateFields>b__24_1(KeyValuePair<String, HotKey> hotkeyDictionaryPair) { }
	...
	private static List<HotkeysScreenField> gameplayAdvancedFields; //Field offset: 0x18
	private static List<HotkeysScreenField> sandboxAdvancedFields; //Field offset: 0x20
	private static List<HotkeysScreenField> allFields; //Field offset: 0x28
	...
	public GameObject gameplayAdvancedContainer; //Field offset: 0x60
	public GameObject sandboxAdvancedContainer; //Field offset: 0x68
	private HotkeysScreenField fieldBeingChanged; //Field offset: 0x70
	public Toggle standardCursorToggle; //Field offset: 0x78
	public Toggle largeCursorToggle; //Field offset: 0x80
	public Toggle xLargeCursorToggle; //Field offset: 0x88
	public List<Transform> cursorPerformanceWarnings; //Field offset: 0x90
	private InputAction actionToRebind; //Field offset: 0x98
	private RebindingOperation rebindingOperation; //Field offset: 0xA0
	private float modifierKeyTimeout; //Field offset: 0xA8
	private HotkeyModifier currentKeyModifier; //Field offset: 0xAC
	private string currentModifierPath; //Field offset: 0xB0
	private bool saved; //Field offset: 0xB8
	...
	[CompilerGenerated]
	private void <Open>b__21_0(bool isOn) { }

	[CompilerGenerated]
	private void <Open>b__21_1(bool isOn) { }

	[CompilerGenerated]
	private void <Open>b__21_2(bool isOn) { }
