...
public class HotkeysData2
{
	...
	public readonly Dictionary<String, HotKey> monkeysAdvanced; //Field offset: 0x28
	public readonly Dictionary<String, HotKey> gameplayAdvanced; //Field offset: 0x30
	public readonly Dictionary<String, HotKey> sandboxAdvanced; //Field offset: 0x38
