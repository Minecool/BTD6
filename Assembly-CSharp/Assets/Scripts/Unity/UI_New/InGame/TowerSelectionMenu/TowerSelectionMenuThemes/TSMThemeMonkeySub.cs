...
public class TSMThemeMonkeySub : TSMThemeDefault
{
	...
	private int lastFrameSubmergeButtonWasClicked; //Field offset: 0xC0
	public Button submergeButton; //Field offset: 0xC8
	public GameObject submergeIcon; //Field offset: 0xD0
	public GameObject unsubmergeIcon; //Field offset: 0xD8
	public Image cooldownFade; //Field offset: 0xE0
	private int submergeCooldownFrames; //Field offset: 0xE8
