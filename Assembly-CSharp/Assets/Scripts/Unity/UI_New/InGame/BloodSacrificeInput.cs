...
public class BloodSacrificeInput : CustomInput
{
	[CompilerGenerated]
	private sealed class <>c__DisplayClass5_0
	{
		public TowerToSimulation bridgeTower; //Field offset: 0x10
		public BloodSacrificeInput <>4__this; //Field offset: 0x18
