...
public class PropSelectionMenuThemeManager : MenuThemeManager
{
	[CompilerGenerated]
	...
	private sealed class <UpdateThemeAsync>d__1 : IEnumerator<Object>, IEnumerator, IDisposable
	{
		...
		public Selectable selected; //Field offset: 0x20
		private <>c__DisplayClass1_0 <>8__1; //Field offset: 0x28
		public PropSelectionMenuThemeManager <>4__this; //Field offset: 0x30
		private PropToSimulation <prop>5__2; //Field offset: 0x38
	...
	public PropSelectionMenuThemeManager() { }
	...
	public void UpdateName(PropToSimulation prop) { }

	[IteratorStateMachine(typeof(<UpdateThemeAsync>d__1))]
	public virtual IEnumerator UpdateThemeAsync(Selectable selected) { }
