...
public class GameEditorModel : IHasCustomMapModel, IContentBrowserData
{
	[JsonProperty]
	...
	public static GameEditorModel DefaultGameEditorModel
	{
		 get { } //Length: 221
	}

	public GameEditorModel() { }

	public override CustomMapModel get_CustomMapModel() { }

	public static GameEditorModel get_DefaultGameEditorModel() { }
