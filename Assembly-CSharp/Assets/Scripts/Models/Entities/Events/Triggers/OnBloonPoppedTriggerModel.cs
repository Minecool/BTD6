...
[Implementation(typeof(OnBloonPoppedTrigger), False, False, new IL2CPP_TYPE_IL2CPP_TYPE_INDEX[] {}])]
public class OnBloonPoppedTriggerModel : EntityTriggerModel
{
	...
	public OnBloonPoppedTriggerModel(string name, float range, String[] bloonIds, bool camoOnly, bool regrowOnly, bool fortifiedOnly, bool moabOnly, bool inverseChecks) { }
