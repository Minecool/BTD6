...
public class PropPackUnlockLoot : BaseLoot
{
	public string propPackName; //Field offset: 0x20

	public PropPackUnlockLoot(string propPackName) { }

	public PropPackUnlockLoot(String[] param) { }
