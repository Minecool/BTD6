...
public class AddBehaviorToTowerSupportModel : SupportModel
{
	...
	public AddBehaviorToTowerSupportModel(string name, TowerBehaviorModel[] behaviors, string mutationId, TowerFilterModel[] filters, string buffLocsName, string buffIconName) { }
