...
[Implementation(typeof(ActivateRateSupportZone), False, False, new IL2CPP_TYPE_IL2CPP_TYPE_INDEX[] {}])]
public class ActivateRateSupportZoneModel : AbilityBehaviorBuffModel
{
	...
	public ActivateRateSupportZoneModel(string name, string mutatorId, bool isUnique, float rateModifier, float range, float maxNumTowersModified, bool canEffectThisTower, float lifespan, DisplayModel addEffectToTowersAffected, string buffLocsName, string buffIconName, TowerFilterModel[] filters, bool useTowerRange) { }
