...
public class DiscountZoneModel : TowerBehaviorBuffModel
{
	...
	public bool affectSelf; //Field offset: 0x58
	public int tierCap; //Field offset: 0x5C
	public int tierMin; //Field offset: 0x60
	...
	public bool isGlobal; //Field offset: 0x89

	public DiscountZoneModel(string name, float discountMultiplier, int stackLimit, string stackName, bool affectSelf, int tierCap, int tierMin, string buffLocsName, string buffIconName, string towerBaseIds, string upgradeId, bool dontAffectOthersInCoop, bool isGlobal, bool isBuffFromArea = false) { }
