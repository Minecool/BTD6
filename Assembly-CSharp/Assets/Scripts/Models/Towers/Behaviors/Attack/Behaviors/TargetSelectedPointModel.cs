...
[Implementation(typeof(TargetSelectedPoint), False, False, new IL2CPP_TYPE_IL2CPP_TYPE_INDEX[] {}])]
public class TargetSelectedPointModel : TargetSupplierModel
{
	...
	public TargetSelectedPointModel(string name, bool isSelectable, bool isOnSubTower, PrefabReference display, float scale, string customName, bool lockToInsideTowerRange, bool startWithClosestTrackPoint, PrefabReference displayInvalid, bool alwaysShowTarget, ProjectileModel projectileToExpireOnTargetChangeModel, bool useTerrainHeight) { }
