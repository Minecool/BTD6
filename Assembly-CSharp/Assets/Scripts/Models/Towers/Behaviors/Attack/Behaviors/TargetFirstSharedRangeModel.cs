...
[Implementation(typeof(TargetFirstSharedRange), False, False, new IL2CPP_TYPE_IL2CPP_TYPE_INDEX[] {}])]
public class TargetFirstSharedRangeModel : TargetSupplierModel
{
	...
	public TargetFirstSharedRangeModel(string name, bool isSelectable, bool isSharedRangeEnabled, bool isOnSubTower, bool isGlobalRange, bool isGettingRangeFromSpecificTower = false, string specificTowerType = "") { }
