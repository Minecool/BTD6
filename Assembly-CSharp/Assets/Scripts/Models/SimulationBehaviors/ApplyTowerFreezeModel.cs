...
public class ApplyTowerFreezeModel : SimulationBehaviorModel
{
	...
	public AudioClipReference freezeSound; //Field offset: 0x40
	private TowerFreezeMutator mutator; //Field offset: 0x48
	...
	public ApplyTowerFreezeModel(string name, int stunFrequencyRounds, int stunDurationRounds, PrefabReference towerStunEffect, AudioClipReference freezeSound) { }
