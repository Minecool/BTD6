...
public class GiveArtifact : ISimulationTestStep
{
	[CompilerGenerated]
	private sealed class <Run>d__2 : IEnumerator<Object>, IEnumerator, IDisposable
	{
		...
		public GiveArtifact <>4__this; //Field offset: 0x28
	...
	[SerializeField]
	private string artifactName; //Field offset: 0x10

	public GiveArtifact(string artifactName) { }
