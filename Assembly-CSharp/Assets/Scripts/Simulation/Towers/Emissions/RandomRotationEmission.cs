...
public class RandomRotationEmission : Emission
{
	public RandomRotationEmissionModel randomRotationEmissionModel; //Field offset: 0x70

	public RandomRotationEmission() { }
