...
public class TargetTag : TargetSupplier
{
	[CompilerGenerated]
	private sealed class <GetTargets>d__4 : IEnumerable<Target>, IEnumerable, IEnumerator<Target>, IEnumerator, IDisposable
	{
		...
		public TargetTag <>4__this; //Field offset: 0x68
	...
	public TargetTagModel targetTagModel; //Field offset: 0x68

	public TargetTag() { }

	public bool FilterWithTag(Target target) { }
