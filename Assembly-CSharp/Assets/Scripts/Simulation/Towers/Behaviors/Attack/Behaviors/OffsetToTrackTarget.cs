...
public class OffsetToTrackTarget : TargetSupplier
{
	[CompilerGenerated]
	private sealed class <GetTargets>d__4 : IEnumerable<Target>, IEnumerable, IEnumerator<Target>, IEnumerator, IDisposable
	{
		...
		public OffsetToTrackTarget <>4__this; //Field offset: 0x68
	...
	public OffsetToTrackTargetModel offsetToTrackTargetModel; //Field offset: 0x68
