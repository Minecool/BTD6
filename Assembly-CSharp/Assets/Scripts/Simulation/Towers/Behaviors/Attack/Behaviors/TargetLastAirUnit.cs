...
public class TargetLastAirUnit : TargetSupplier
{
	[CompilerGenerated]
	private sealed class <GetTargets>d__7 : IEnumerable<Target>, IEnumerable, IEnumerator<Target>, IEnumerator, IDisposable
	{
		...
		public TargetLastAirUnit <>4__this; //Field offset: 0x68
	...
	public TargetLastAirUnitModel targetLastAirUnitModel; //Field offset: 0x68
