...
public class RandomPositionBasic : TargetSupplier
{
	[CompilerGenerated]
	private sealed class <GetTargets>d__4 : IEnumerable<Target>, IEnumerable, IEnumerator<Target>, IEnumerator, IDisposable
	{
		...
		public RandomPositionBasic <>4__this; //Field offset: 0x68
	...
	public RandomPositionBasicModel posModel; //Field offset: 0x68
