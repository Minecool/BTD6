...
public class CirclePatternClose : CirclePattern
{
	[CompilerGenerated]
	private sealed class <GetTargets>d__4 : IEnumerable<Target>, IEnumerable, IEnumerator<Target>, IEnumerator, IDisposable
	{
		...
		public CirclePatternClose <>4__this; //Field offset: 0x68
	...
	public CirclePatternCloseModel circlePatternCloseModel; //Field offset: 0xC0

	public CirclePatternClose() { }
