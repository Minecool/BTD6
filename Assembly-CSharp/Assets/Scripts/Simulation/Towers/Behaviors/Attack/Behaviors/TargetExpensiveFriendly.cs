...
public class TargetExpensiveFriendly : TargetSupplier
{
	[CompilerGenerated]
	private sealed class <GetTargets>d__5 : IEnumerable<Target>, IEnumerable, IEnumerator<Target>, IEnumerator, IDisposable
	{
		private int <>1__state; //Field offset: 0x10
		private Target <>2__current; //Field offset: 0x18
		private int <>l__initialThreadId; //Field offset: 0x60
		public TargetExpensiveFriendly <>4__this; //Field offset: 0x68
	...
	public TargetExpensiveFriendlyModel expensiveFriendlyTargetModel; //Field offset: 0x68
	...
	[IteratorStateMachine(typeof(<GetTargets>d__5))]
