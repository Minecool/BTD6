...
public class TargetStrongAirUnit : TargetSupplier
{
	[CompilerGenerated]
	private sealed class <GetTargets>d__7 : IEnumerable<Target>, IEnumerable, IEnumerator<Target>, IEnumerator, IDisposable
	{
		...
		public TargetStrongAirUnit <>4__this; //Field offset: 0x68
	...
	public TargetStrongAirUnitModel targetStrongModel; //Field offset: 0x68
