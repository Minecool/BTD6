...
public class BrewTargetting : TargetSupplier
{
	[CompilerGenerated]
	private sealed class <GetTargets>d__6 : IEnumerable<Target>, IEnumerable, IEnumerator<Target>, IEnumerator, IDisposable
	{
		...
		public BrewTargetting <>4__this; //Field offset: 0x68
		private Enumerator<Tower> <>7__wrap1; //Field offset: 0x70
	...
	public BrewTargettingModel brewTargettingModel; //Field offset: 0x68
