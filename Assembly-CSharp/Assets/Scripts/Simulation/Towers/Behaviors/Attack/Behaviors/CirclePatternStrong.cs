...
public class CirclePatternStrong : CirclePattern
{
	[CompilerGenerated]
	private sealed class <GetTargets>d__4 : IEnumerable<Target>, IEnumerable, IEnumerator<Target>, IEnumerator, IDisposable
	{
		...
		public CirclePatternStrong <>4__this; //Field offset: 0x68
	...
	public CirclePatternStrongModel circlePatternStrongModel; //Field offset: 0xC0

	public CirclePatternStrong() { }
