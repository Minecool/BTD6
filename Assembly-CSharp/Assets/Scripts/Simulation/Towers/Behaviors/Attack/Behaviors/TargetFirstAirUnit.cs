...
public class TargetFirstAirUnit : TargetSupplier
{
	[CompilerGenerated]
	private sealed class <GetTargets>d__7 : IEnumerable<Target>, IEnumerable, IEnumerator<Target>, IEnumerator, IDisposable
	{
		...
		public TargetFirstAirUnit <>4__this; //Field offset: 0x68
	...
	public TargetFirstAirUnitModel targetFirstAirUnitModel; //Field offset: 0x68
