...
public class CirclePatternFirst : CirclePattern
{
	[CompilerGenerated]
	private sealed class <GetTargets>d__4 : IEnumerable<Target>, IEnumerable, IEnumerator<Target>, IEnumerator, IDisposable
	{
		...
		public CirclePatternFirst <>4__this; //Field offset: 0x68
	...
	public CirclePatternFirstModel circlePatternFirstModel; //Field offset: 0xC0

	public CirclePatternFirst() { }
