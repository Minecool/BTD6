...
public class CloseTargetTrack : TrackTargetSupplier
{
	[CompilerGenerated]
	private sealed class <GetTargets>d__7 : IEnumerable<Target>, IEnumerable, IEnumerator<Target>, IEnumerator, IDisposable
	{
		...
		public CloseTargetTrack <>4__this; //Field offset: 0x68
	...
	public CloseTargetTrackModel targetTrackModel; //Field offset: 0x78
	private Vector3 closestPoint; //Field offset: 0x80
