...
public class TargetRightHand : TargetSupplier
{
	[CompilerGenerated]
	private sealed class <GetTargets>d__9 : IEnumerable<Target>, IEnumerable, IEnumerator<Target>, IEnumerator, IDisposable
	{
		...
		public TargetRightHand <>4__this; //Field offset: 0x68
	...
	public TargetRightHandModel targetRightHandModel; //Field offset: 0x68
	public TargetType targetType; //Field offset: 0x70
	private TargetLeftHand leftHand; //Field offset: 0x88
	public Target leftHandTarget; //Field offset: 0x90
