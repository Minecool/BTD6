...
public class TargetSuppliedPosition : TargetSupplier
{
	[CompilerGenerated]
	private sealed class <GetTargets>d__6 : IEnumerable<Target>, IEnumerable, IEnumerator<Target>, IEnumerator, IDisposable
	{
		...
		public TargetSuppliedPosition <>4__this; //Field offset: 0x68
	...
	public TargetSuppliedPositionModel behaviorModel; //Field offset: 0x68
	public Nullable<Vector3> targetPosition; //Field offset: 0x70
