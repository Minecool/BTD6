...
public class ActivateVisibilitySupportZone : ActivateTowerSupportZone
{
	public ActivateVisibilitySupportZoneModel activateVisibilitySupportZoneModel; //Field offset: 0x88
